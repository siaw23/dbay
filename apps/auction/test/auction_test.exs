defmodule AuctionTest do
  ...
  describe "list_items/0" do
    ...
    test "return all items", %{items: items} do
  ...
  describe "get_item/1" do
    ...
    test "returns a single Item", %{items: items} do
  ...
  describe "insert_item/1" do
    test "adds an item to the DB" do
    ...
    test "Item in db has attributes provided" do
    ...
    test "it return an error on error" do
